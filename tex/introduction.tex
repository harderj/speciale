...
was essential in order to understand the results of \ncite{F20} and related papers
...
This provides an introduction to the field of RL and Q-learning and sheds light 
...
In section 3.3 the preprint \mcite{F20} is introduced
